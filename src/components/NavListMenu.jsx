...
export function NavListMenu() {
  ...
  return (
    <div className=" z-96 m-auto my-4 px-4 max-h-[768px] w-full ">
      <div className="fixed items-center justify-center w-full pr-8">
        <Navbar className=" bg-gray-300 top-0 z-10 h-max max-w-full rounded-x shadow-2xll px-4 py-2 lg:px-8 lg:py-4">
