      ...
      <div className="bg-white shadow-lg rounded-lg flex flex-col md:flex-row w-full">
        <div className="flex flex-col w-full p-4 md:p-8 text-center">
          ...
          <p className="text-gray-700 mb-8 text-lg relative">
            "Our services epitomize quality. With a seasoned team of experts, we
            ensure precision, creativity, and innovation in every project.
            Leveraging cutting-edge technology, we deliver tailored solutions
            that exceed expectations. From start to finish, our commitment to
            excellence drives customer satisfaction and success."
          </p>
        </div>
      </div>
      <div className="flex flex-wrap justify-center gap-8 mt-8">
        {services.map((service, index) => (
          <Card
            key={index}
            shadow={true}
            className="w-full md:w-1/3 lg:w-1/4 hover:scale-105 transition-transform duration-300 ease-in-out"
          >
            <CardHeader className="h-64 mt-4">
              <img
                src={service.image}
